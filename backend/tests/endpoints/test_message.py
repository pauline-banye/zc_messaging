...
reaction_test_url = "api/v1/org/619ba4/rooms/343235/messages/346556/reaction"

reaction_test_payload = {
        "name": "lol",
        "count": 1,
        "emoji": "lol",
        "reactedUsersId": ["e21e10"]
    }
# get_message_success_response = {
#     "status": "success",
...
# sidebar_success_response = {
#     "status":"success",
#     "message":"success",
#     "data":[
#         {
#             "name":"Channels",
#             "description":"Sends messages between users in a channel",
#             "plugin_id":"chat.zuri.chat",
#             "organisation_id":"619ba4671a5f54782939d384",
#             "user_id":"619ba4671a5f54782939d385",
#             "group_name":"CHANNEL",
#             "category":"channels",
#             "show_group":False,
#             "button_url":"/channels",
...
#                     "image_url":"",
#                     "room_id":"61e6855e65934b58b8e5d1df",
#                     "room_url":"/channel/61e6855e65934b58b8e5d1df"},
#                 {
#                     "room_name":"general",
#                     "image_url":"",
#                     "room_id":"61e59de865934b58b8e5d1c7",
#                     "room_url":"/channel/61e59de865934b58b8e5d1c7"
#                  }
#                 ],
#             "starred_rooms":[],
#             "joined_rooms":[
...
#             "description":"Sends direct messages between users",
#             "plugin_id":"chat.zuri.chat",
#             "organisation_id":"619ba4671a5f54782939d384",
#             "user_id":"619ba4671a5f54782939d385",
#             "group_name":"DM",
...
#                 {
#                     "room_name":"",
#                     "image_url":"https://cdn.iconscout.com/icon/free/png-256/account-avatar-profile-human-man-user-30448.png",
#                     "room_id":"61e59de865934b58b8e5d1c8",
#                     "room_url":"/dm/61e59de865934b58b8e5d1c8"
#                     }
#                 ]
#             }
#         ]
...
@pytest.mark.asyncio
@mock.patch.object(DataStorage, "__init__", lambda x, y: None)
async def test_add_reaction_successful(mock_dataStorage_read, mock_dataStorage_update):
    """Add reaction successful.
    Args:
        mock_dataStorage_read (AsyncMock): Asynchronous external api call
        mock_dataStorage_update (AsyncMock): Asynchronous external api call
    """
    ...
    response = client.post(reaction_test_url, json=reaction_test_payload)
    assert response.status_code == 200
    assert response.json() == {
        "status": "success",
