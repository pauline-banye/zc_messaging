...
# remove_member_success_response = {
#     "status": "success",
...
# async def test_remove_member_successful(
...
#     fake_room_data["room_type"] = "CHANNEL"
#     admin_id = {
#         "61696f5ac4133ddaa309dcfe": {
#             "closed": False,
#             "role": "admin",
...
#     mock_dataStorage_read.return_value == admin_id
#     mock_dataStorage_update.return_value == update_response
#     mock_centrifugo.return_value = centrifugo_response

#     response = client.patch(url=remove_member_test_url)
#     assert response.status_code == 404
#     assert response.json() == remove_member_success_response
