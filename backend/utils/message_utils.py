...
async def get_room_messages(org_id: str, room_id: str) -> dict:
    ...
    Returns:
        ...
        dict: key value pair of messages in the room mapped according to message schema
    """
...
async def get_message(org_id: str, room_id: str, message_id: str) -> dict:
    ...
    Returns:
        dict: key value pair of the specific message mapped according to message schema
    """
    DB = DataStorage(org_id)
